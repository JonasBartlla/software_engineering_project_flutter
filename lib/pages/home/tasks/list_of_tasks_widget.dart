...
class _ListOfTasksState extends State<ListOfTasks> {
  ...
  static List<SortFields> fields = [
    SortFields("Erstellungsdatum (früheste zuerst)", Icons.arrow_upward_sharp),
    SortFields("Erstellungsdatum (ältestes zuerst)", Icons.arrow_downward_sharp),
    SortFields("Priorität (wichtigste zuerst)", Icons.arrow_upward_sharp),
    SortFields("Priorität (wichtigste zuerst)", Icons.arrow_downward_sharp),
    SortFields("Fälligkeit (frühestes zuerst)", Icons.arrow_upward_sharp),
    SortFields("Fälligkeit (ältestes zuerst)", Icons.arrow_downward_sharp)
  ];
